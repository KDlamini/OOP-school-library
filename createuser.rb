...
module CreateUser
  ...
  def add_student
    ...
    update_users(Student.new(age: age.to_i, name: name, parent_permission: parent_permission))
    response('Student')
  end
  ...
  def add_teacher
    ...
    update_users(Teacher.new(specialization: specialization, age: age.to_i, name: name))
    response('Teacher')
  end
end
